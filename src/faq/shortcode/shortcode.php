 ...
 *
 * @package     NickDavis\Module\FAQ\Shortcode
 * @since       1.0.0
 * @author      Nick Davis
 * @link        https://iamnickdavis.com
 * @license     GNU General Public License 2.0+
 */
namespace NickDavis\Module\FAQ\Shortcode;
...
function process_the_shortcode( $user_defined_attributes, $content, $shortcode_name ) {
	$config = get_shortcode_configuation();
 ...
 * @return array
 */
function get_shortcode_configuation() {
	return array(
		'views'    => array(
		...
		'defaults' => array(
			...
			'none_found_by_topic'     => __( 'Sorry, no FAQs were found for that topic.', 'collapsible-content' ),
			'none_found_single'       => __( 'Sorry, no FAQ found.', 'collapsible-content' ),
		),
	);
}
