...
use NickDavis\Module\FAQ\Shortcode as Shortcode;
use NickDavis\Module\FAQ\Templates as Template;

if ( isset( $use_term_container ) && $use_term_container ) : ?>
<div class="collapsible-content--term-contaniner faq faq-topic--<?php esc_attr_e( $term_slug ); ?>">
<?php endif; ?>
